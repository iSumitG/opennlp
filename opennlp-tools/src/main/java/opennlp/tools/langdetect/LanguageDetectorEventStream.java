 ...
 */
public class LanguageDetectorEventStream extends AbstractEventStream<LanguageDetectorSample> {
   ...
   */
  public LanguageDetectorEventStream(ObjectStream<LanguageDetectorSample> data) {
    super(data);
